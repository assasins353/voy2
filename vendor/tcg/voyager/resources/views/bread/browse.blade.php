                            ...
                            <table id="dataTable" class="table table-hover">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        @endforeach
                                        @if( $_SERVER['REQUEST_URI']=="/admin/competitions")
                                            ...
                                            @endcan
                                            @can('read', $data)
                                                <a href="editions" title="{{ __('voyager.generic.view') }}" class="btn btn-sm btn-warning pull-right">
                                                    <i class=""></i> <span class="">gestion editions</span>
                                                </a>
                                            @endcan  
